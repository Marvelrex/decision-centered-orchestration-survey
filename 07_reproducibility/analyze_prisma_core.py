...
def write_report(
    ...
    lines.extend(
        [
            ...
            f"- Records entering retrospective screening: {resolution['records_for_screening']:,}",
            "",
    ...
    lines.extend(
        [
            ...
            "The completed duplicate review supports removal of 512 duplicate records and 10 superseded preprint records, leaving 4,464 records for retrospective screening.",
            "",
